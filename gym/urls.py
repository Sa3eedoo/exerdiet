...
exercises_router = routers.NestedDefaultRouter(router,
                                               'exercises',
                                               lookup='exercise')

custom_exercises_router = routers.NestedDefaultRouter(router,
                                                      'custom_exercises',
                                                      lookup='custom_exercise')
...
urlpatterns = router.urls + exercises_router.urls + custom_exercises_router.urls + \
    workouts_router.urls + performed_workouts_router.urls
